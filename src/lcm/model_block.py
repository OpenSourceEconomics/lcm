...
class ModelBlock:
    ...
    def get_current_utility(self, period: int, on: Literal["state_choice", "state_choice_space"]):
        pass
    
    def get_value_function(self, period: int, on: Literal["state", "state_space"]):
        pass

    def get_total_utility(self, period: int, on: Literal["state_choice", "state_choice_space"]):
        pass

    def get_feasibility(self, period: int, on: Literal["state_choice", "state_choice_space"]):
        pass

    def get_solve_continuous_problem(self, period: int, on: Literal["state_choice", "state_choice_space"]):
        """Reference: create_compute_conditional_continuation_value"""
        pass

    def get_argsolve_continuous_problem(self, period: int, on: Literal["state_choice", "state_choice_space"]):
